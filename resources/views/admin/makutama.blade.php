...
<section class="w-full">
    <div id="mainbar" class="fixed left-0 top-0 pt-16 w-full md:pl-64">
        <div class="px-4 md:px-8">
            <h1 class="text-start capitalize text-3xl py-5">Data Makanan</h1>
            ...
            <div class="mt-20">
                ...
                <div class="  ">
                    ...
                    <div class="flex items-end py-5">
                        <a href="/admin/{{$mutama->first()->id_products}}/create">
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-1 text-center">Harga Makanan</th>
                                <th scope="col" class="px-4 py-1">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($mutama as $data)
                                                    <tr class="border-b dark:border-gray-700">
                                                        ...
                                                        <td class="px-4 py-3 text-end">
                                                            <form action="/update-mutama/{{ $data->id }}" method="POST"
                                                                ...
                                                                <ul class="flex items-end space-x-4">
                                                                    <!-- Tombol Minus -->
                                                                    <li>
                                                                        <button type="button" onclick="decreaseStock({{ $data->id }})"
                                                                    ...
                                                                    <!-- Tampilan Stok -->
                                                                    <li>
                                                                        <input type="number" name="stok_menu" id="stok-{{ $data->id }}"
                                                                            value="{{ $data->stok_menu }}"
                                                                            class="text-center border border-gray-300 w-16 rounded" readonly>
                                                                    </li>

                                                                    <!-- Tombol Plus -->
                                                                    <li>
                                                                        <button type="button" onclick="increaseStock({{ $data->id }})"
                                                            ...
                                                            <ul class="flex items-end space-x-4">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form action="{{ route('admin.menus.destroy', $data->id) }}" method="POST"
                                                                        ...
                                                                        <button type="submit" class="font-medium text-white hover:underline px-4 py-2 rounded bg-black"
                                                                            onclick="return confirm('Anda yakin ingin menghapus menu \'{{
                                $data->nama_menu }}\'? Data yang dihapus tidak bisa
                                                                            dikembalikan.')">
                                                                            Hapus
                                                                        </button>
                                                                    </form>
